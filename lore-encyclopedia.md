...
A collaborative wiki documenting the leaked files, recovered testimony, and ongoing investigation into the [Miter Corporation](entries/organizations/Miter-Corporation.md), the [Saint Juniper Research Campus](entries/locations/Saint-Juniper-Research-Campus.md), and the entity known as [G*BOY](entries/subjects/G-BOY.md).
...
|---|---|---|
| [Z*L1NE](entries/people/Z-L1NE.md) | `entries/people/Z-L1NE.md` | Bloc co-founder and communications infiltrator |

### Subjects

| Display Name | File | Description |
|---|---|---|
| [G*BOY](entries/subjects/G-BOY.md) / [G-304](entries/subjects/G-BOY.md) | `entries/subjects/G-BOY.md` | Tier-0 prototype; escaped Saint Juniper; archetypal presence |
...
This table maps display names used in `[[wiki links]]` to their canonical filenames.

| Display Name | Filename | Status |
|---|---|---|
| G\*BOY | `entries/subjects/G-BOY.md` | Live |
| G-304 | `entries/subjects/G-BOY.md` | Redirect (same article) |
| Z\*L1NE | `entries/people/Z-L1NE.md` | Live |

> **Convention:** Entries live under `entries/<type>/` (people, subjects, locations, events, concepts, organizations, technology). Filenames use identifier-preserving slugs. Use paths like `entries/people/Z-L1NE.md` for links.

---

*This wiki draws content from the lore-repo (lore drops, video transcripts, decoded files) and the Neuko community wiki. All articles follow the structure defined in the wiki-entry-generator skill.*
