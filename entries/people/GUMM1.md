...
**GUMM1** (also known as **Gummi** or **Gummy**) is an American computer security researcher and activist. They are best known as a co-founder of [The Bloc](../organizations/The-Bloc.md), an organization that investigates alleged corporate misconduct by the [Miter Corporation](../organizations/Miter-Corporation.md) and related entities.

**At a glance**

- Co-founded The Bloc (1999) with [Z*L1NE](Z-L1NE.md) and [1NK](1NK.md)
- Co-authored *G*BOY Manifesto: Sigils, Symbols, and Memetic Rebellion* (1999)
- Specializes in data analysis and computer security research
- Active in ongoing investigations into [Saint Juniper Research Campus](../locations/Saint-Juniper-Research-Campus.md)
- Family member targeted by alleged Harmony Program operations
...
GUMM1 met [Z*L1NE](Z-L1NE.md) at the St. Juniper Paranormal Museum around 1999. Along with fellow researcher [1NK](1NK.md), who had gained unauthorized access to Miter Corporation systems, the three formed The Bloc and established operations in basement facilities provided by the museum's proprietor, Magdalena.
...
GUMM1 continues to participate in The Bloc's research activities. Recent communications indicate ongoing data gathering efforts related to the research campus and its secure networks. GUMM1's technical work focuses on extracting and analyzing materials from compromised systems, working in coordination with [1NK](1NK.md) and [Z*L1NE](Z-L1NE.md).

## Technical expertise

GUMM1 specializes in computer security research and data analysis. Within The Bloc's structure, they function as a technical researcher responsible for processing and interpreting materials obtained from secure institutional systems.
